          ...
          <div class="mx-auto flex max-w-md flex-col justify-center lg:min-h-[70vh]">
            ...
            <form class="mt-7 space-y-5" autocomplete="off">
              <label class="form-control w-full">
                <span class="mb-2 text-sm font-medium text-slate-700">Full name</span>
                <input
                  type="text"
              ...
              <label class="form-control w-full">
                <span class="mb-2 text-sm font-medium text-slate-700">Confirm password</span>
                <input
                  type="password"
            ...
            >
              ...
              <a href="/signin" class="text-sm font-semibold text-sky-700 hover:text-sky-800"
                >Sign in</a
              >
            </div>
          </div>
